...
const Artworks = ({textLeave,textEnter}) => {
  ...
  const titleSpring = (show) =>  useSpring({
    ...
    letterSpacing: show ? "0.1em" : windowWidth < 800 ? windowWidth < 500 ? "0.2em" : "0.5em" : "0.8em",
  });

  const descSpring = (show) => useSpring({
    opacity: show ? 1 : 0,
    transform: show ? "scale(1) " : "scale(1.5)",
    letterSpacing: show ? "0.1em" : windowWidth < 800 ? windowWidth < 500 ? "0.15em" : "0.3em"  : "0.8em",
  });
  ...
  return (
    <div className=" text-white items-center ">
      <div className=" overflow-hidden">
        ...
        <div className="flex flex-col gap-[10rem] mx-auto relative max-xl:max-w-[80%] h-[400vh] max-md:h-[250vh] max-md:gap-5">
