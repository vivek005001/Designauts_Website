    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-4 p-8 rounded-lg shadow-lg">
          <img
            src="/pfps/Prashasti Singh.png" // Replace with your image URL
            alt="Profile"
            className="w-40 h-40 rounded-full object-cover mb-4 border-white border-4"
          />
          <h3 className="text-2xl font-bold">Prashasti</h3>
          <p className="text-gray-400">Coordinator</p>
          <p className="text-gray-400">Phone: 7357639330</p>
