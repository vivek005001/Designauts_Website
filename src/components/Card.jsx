...
function Card({ name, post, tag, img, linkedin, instagram, bg, customCss }) {
  ...
  return (
    <Tilt options={defaultSettings}>
      <div className="container max-h-[480px] w-[320px] z-30 px-5 mb-24 flex flex-col justify-center items-center cursor-pointer">
        ...
        <div className={`object overflow-hidden ${bg}`} >
          {img ?
        ...
        {post &&
          <div className="flex gap-3 justify-evenly items-center text-3xl text-white overflow-hidden">
            ...
            <span className={`text-2xl ${customCss} text-center`}>{post}</span>
